...
function main() {
  let v1 = [new Interval(1, 5), new Interval(3, 7), new Interval(4, 6)], v2 = [
    new Interval(1, 5),
    new Interval(4, 6),
    new Interval(6, 8),
    new Interval(11, 15)
    ...
    new Interval(10, 12),
    new Interval(11, 15)
  ], v4 = [new Interval(1, 5)], v6 = [new Interval(1, 9), new Interval(4, 4), new Interval(3, 8)], v7 = [new Interval(1, 2), new Interval(3, 4), new Interval(8, 8)], v8 = [new Interval(1, 5), new Interval(1, 3)], v9 = [new Interval(1, 5), new Interval(6, 9)], v10 = [new Interval(0, 0), new Interval(1, 18), new Interval(1, 3)];
  let vList = [v1, v2, v3, v4, v6, v7, v8, v9, v10];
  for (let i = 0; i < vList.length; i++) {
    console.log(i + 1 + ". Intervals to merge:", intervalListToStr(vList[i]));
